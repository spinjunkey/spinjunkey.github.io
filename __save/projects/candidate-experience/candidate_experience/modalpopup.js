...
function ShowModalPopup(modalPopupID, altText, imageLocation) {
	var modal = document.getElementById('dvPopup');
...
function HideModalPopup(modalPopupID) {
	var modal = document.getElementById("dvPopup");		
	var modalImg = document.getElementById("img01");	
	modalImg.src = "images/transparent.gif";
